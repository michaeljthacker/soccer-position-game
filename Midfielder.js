...
export class Midfielder extends Player {
    ...
    calculateIdealPosition(ballX, ballY, teammates, opponents) {
        ...
        const defenderY = Math.min(...teammates
            ...
            .map(player => getDistance(player.x, player.y, goalX, defendingGoalY)));  // Find closest defender to defending goal
        ...
        const forwardY = Math.min(...teammates
            ...
            .map(player => getDistance(player.x, player.y, goalX, attackingGoalY)));  // Find closest forward to attacking goal
